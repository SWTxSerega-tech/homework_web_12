...
set -gx VIRTUAL_ENV 'C:\Users\SWT\Documents\Courses docx\PyWeb\homework_web_12\project\.venv'
...
if test -n project-py3.14
    set -gx VIRTUAL_ENV_PROMPT project-py3.14
else
